...
type MsgVpnRestDeliveryPointQueueBindingRequestHeader struct {
	// The name of the HTTP request header.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\".
	HeaderName string `json:"headerName,omitempty"`
	// A substitution expression for the value of the HTTP request header.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\". The minimum access scope/level required to change this attribute is \"vpn/read-write\". Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is `\"\"`.
