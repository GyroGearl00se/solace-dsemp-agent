...
type MsgVpnDmrBridge struct {
	...
	// The remote Message VPN of the DMR Bridge.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\". The minimum access scope/level required to change this attribute is \"global/mesh-manager\". Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is `\"\"`.
	RemoteMsgVpnName string `json:"remoteMsgVpnName,omitempty"`
	// The name of the node at the remote end of the DMR Bridge.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\".
