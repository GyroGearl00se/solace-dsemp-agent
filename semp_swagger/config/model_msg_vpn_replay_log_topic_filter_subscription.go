...
type MsgVpnReplayLogTopicFilterSubscription struct {
	...
	// The topic of the Subscription.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\".
	TopicFilterSubscription string `json:"topicFilterSubscription,omitempty"`
}
