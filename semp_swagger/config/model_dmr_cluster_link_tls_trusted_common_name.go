...
type DmrClusterLinkTlsTrustedCommonName struct {
	// The name of the Cluster.  The minimum access scope/level required to retrieve this attribute is \"global/read-only\". Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation.
	DmrClusterName string `json:"dmrClusterName,omitempty"`
	// The name of the node at the remote end of the Link.  The minimum access scope/level required to retrieve this attribute is \"global/read-only\". Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation.
	RemoteNodeName string `json:"remoteNodeName,omitempty"`
	// The expected trusted common name of the remote certificate.  The minimum access scope/level required to retrieve this attribute is \"global/read-only\". Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation.
