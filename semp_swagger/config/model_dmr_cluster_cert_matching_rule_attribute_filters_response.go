...
type DmrClusterCertMatchingRuleAttributeFiltersResponse struct {
	Data []DmrClusterCertMatchingRuleAttributeFilter `json:"data,omitempty"`
	Links []DmrClusterCertMatchingRuleAttributeFilterLinks `json:"links,omitempty"`
