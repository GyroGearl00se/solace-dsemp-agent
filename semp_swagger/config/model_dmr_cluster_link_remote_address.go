...
type DmrClusterLinkRemoteAddress struct {
	...
	// The FQDN or IP address (and optional port) of the remote node. If a port is not provided, it will vary based on the transport encoding: 55555 (plain-text), 55443 (encrypted), or 55003 (compressed).  The minimum access scope/level required to retrieve this attribute is \"global/read-only\".
	RemoteAddress string `json:"remoteAddress,omitempty"`
	// The name of the node at the remote end of the Link.  The minimum access scope/level required to retrieve this attribute is \"global/read-only\".
