...
type CertAuthorityOcspTlsTrustedCommonName struct {
	// The name of the Certificate Authority.  The minimum access scope/level required to retrieve this attribute is \"global/read-only\". Deprecated since 2.19. Replaced by clientCertAuthorities.
	CertAuthorityName string `json:"certAuthorityName,omitempty"`
	// The expected Trusted Common Name of the OCSP responder remote certificate.  The minimum access scope/level required to retrieve this attribute is \"global/read-only\". Deprecated since 2.19. Replaced by clientCertAuthorities.
