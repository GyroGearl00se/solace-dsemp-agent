...
type MsgVpnAuthenticationKerberosRealmsResponse struct {
	Data []MsgVpnAuthenticationKerberosRealm `json:"data,omitempty"`
	Links []MsgVpnAuthenticationKerberosRealmLinks `json:"links,omitempty"`
