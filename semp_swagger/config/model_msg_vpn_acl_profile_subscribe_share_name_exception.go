...
type MsgVpnAclProfileSubscribeShareNameException struct {
	...
	// The subscribe share name exception to the default action taken. May include wildcard characters.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\".
	SubscribeShareNameException string `json:"subscribeShareNameException,omitempty"`
	// The syntax of the subscribe share name for the exception to the default action taken.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\". The allowed values and their meaning are:  <pre> \"smf\" - Topic uses SMF syntax. \"mqtt\" - Topic uses MQTT syntax. </pre> 
