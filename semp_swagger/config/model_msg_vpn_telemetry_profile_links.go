...
type MsgVpnTelemetryProfileLinks struct {
	// The URI of this Telemetry Profile's collection of Receiver ACL Connect Exception objects.
	ReceiverAclConnectExceptionsUri string `json:"receiverAclConnectExceptionsUri,omitempty"`
	// The URI of this Telemetry Profile's collection of Trace Filter objects.
	TraceFiltersUri string `json:"traceFiltersUri,omitempty"`
