...
type MsgVpnKafkaSenderQueueBindingsResponse struct {
	Data []MsgVpnKafkaSenderQueueBinding `json:"data,omitempty"`
	Links []MsgVpnKafkaSenderQueueBindingLinks `json:"links,omitempty"`
