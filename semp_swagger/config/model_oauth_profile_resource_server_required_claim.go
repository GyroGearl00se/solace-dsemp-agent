...
type OauthProfileResourceServerRequiredClaim struct {
	...
	// The name of the access token claim to verify.  The minimum access scope/level required to retrieve this attribute is \"global/read-only\".
	ResourceServerRequiredClaimName string `json:"resourceServerRequiredClaimName,omitempty"`
	// The required claim value, which must be a string containing a valid JSON value.  The minimum access scope/level required to retrieve this attribute is \"global/read-only\".
