...
type MsgVpnClientUsernameAttribute struct {
	// The name of the Attribute.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\".
	AttributeName string `json:"attributeName,omitempty"`
	// The value of the Attribute.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\".
