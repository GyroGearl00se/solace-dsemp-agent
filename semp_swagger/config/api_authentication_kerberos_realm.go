...
type AuthenticationKerberosRealmApiService service
/*
AuthenticationKerberosRealmApiService Create a Realm object.
 ...
 * @param body The Realm object&#x27;s attributes.
 * @param msgVpnName The name of the Message VPN.
 * @param optional nil or *AuthenticationKerberosRealmApiCreateMsgVpnAuthenticationKerberosRealmOpts - Optional Parameters:
...
@return MsgVpnAuthenticationKerberosRealmResponse
*/

type AuthenticationKerberosRealmApiCreateMsgVpnAuthenticationKerberosRealmOpts struct {
    OpaquePassword optional.String
    Select_ optional.Interface
}

func (a *AuthenticationKerberosRealmApiService) CreateMsgVpnAuthenticationKerberosRealm(ctx context.Context, body MsgVpnAuthenticationKerberosRealm, msgVpnName string, localVarOptionals *AuthenticationKerberosRealmApiCreateMsgVpnAuthenticationKerberosRealmOpts) (MsgVpnAuthenticationKerberosRealmResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue MsgVpnAuthenticationKerberosRealmResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/msgVpns/{msgVpnName}/authenticationKerberosRealms"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MsgVpnAuthenticationKerberosRealmResponse
...
/*
AuthenticationKerberosRealmApiService Delete a Realm object.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param msgVpnName The name of the Message VPN.
 * @param kerberosRealmName The Realm Name. Must start with \&quot;@\&quot;, typically all uppercase.
@return SempMetaOnlyResponse
*/
func (a *AuthenticationKerberosRealmApiService) DeleteMsgVpnAuthenticationKerberosRealm(ctx context.Context, msgVpnName string, kerberosRealmName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/msgVpns/{msgVpnName}/authenticationKerberosRealms/{kerberosRealmName}"
	localVarPath = strings.Replace(localVarPath, "{"+"msgVpnName"+"}", fmt.Sprintf("%v", msgVpnName), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"kerberosRealmName"+"}", fmt.Sprintf("%v", kerberosRealmName), -1)
...
/*
AuthenticationKerberosRealmApiService Get a Realm object.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param kerberosRealmName The Realm Name. Must start with \&quot;@\&quot;, typically all uppercase.
 * @param optional nil or *AuthenticationKerberosRealmApiGetMsgVpnAuthenticationKerberosRealmOpts - Optional Parameters:
     * @param "OpaquePassword" (optional.String) -  Accept opaque attributes in the request or return opaque attributes in the response, encrypted with the specified password. See the documentation for the &#x60;opaquePassword&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnAuthenticationKerberosRealmResponse
*/

type AuthenticationKerberosRealmApiGetMsgVpnAuthenticationKerberosRealmOpts struct {
    OpaquePassword optional.String
    Select_ optional.Interface
}

func (a *AuthenticationKerberosRealmApiService) GetMsgVpnAuthenticationKerberosRealm(ctx context.Context, msgVpnName string, kerberosRealmName string, localVarOptionals *AuthenticationKerberosRealmApiGetMsgVpnAuthenticationKerberosRealmOpts) (MsgVpnAuthenticationKerberosRealmResponse, *http.Response, error) {
	var (
...
/*
AuthenticationKerberosRealmApiService Get a list of Realm objects.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param msgVpnName The name of the Message VPN.
 * @param optional nil or *AuthenticationKerberosRealmApiGetMsgVpnAuthenticationKerberosRealmsOpts - Optional Parameters:
     ...
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnAuthenticationKerberosRealmsResponse
*/

type AuthenticationKerberosRealmApiGetMsgVpnAuthenticationKerberosRealmsOpts struct {
...
func (a *AuthenticationKerberosRealmApiService) GetMsgVpnAuthenticationKerberosRealms(ctx context.Context, msgVpnName string, localVarOptionals *AuthenticationKerberosRealmApiGetMsgVpnAuthenticationKerberosRealmsOpts) (MsgVpnAuthenticationKerberosRealmsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue MsgVpnAuthenticationKerberosRealmsResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MsgVpnAuthenticationKerberosRealmsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
AuthenticationKerberosRealmApiService Replace a Realm object.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param kerberosRealmName The Realm Name. Must start with \&quot;@\&quot;, typically all uppercase.
 * @param optional nil or *AuthenticationKerberosRealmApiReplaceMsgVpnAuthenticationKerberosRealmOpts - Optional Parameters:
     * @param "OpaquePassword" (optional.String) -  Accept opaque attributes in the request or return opaque attributes in the response, encrypted with the specified password. See the documentation for the &#x60;opaquePassword&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnAuthenticationKerberosRealmResponse
*/

type AuthenticationKerberosRealmApiReplaceMsgVpnAuthenticationKerberosRealmOpts struct {
    OpaquePassword optional.String
    Select_ optional.Interface
}

func (a *AuthenticationKerberosRealmApiService) ReplaceMsgVpnAuthenticationKerberosRealm(ctx context.Context, body MsgVpnAuthenticationKerberosRealm, msgVpnName string, kerberosRealmName string, localVarOptionals *AuthenticationKerberosRealmApiReplaceMsgVpnAuthenticationKerberosRealmOpts) (MsgVpnAuthenticationKerberosRealmResponse, *http.Response, error) {
	var (
...
/*
AuthenticationKerberosRealmApiService Update a Realm object.
 ...
 * @param msgVpnName The name of the Message VPN.
 * @param kerberosRealmName The Realm Name. Must start with \&quot;@\&quot;, typically all uppercase.
 * @param optional nil or *AuthenticationKerberosRealmApiUpdateMsgVpnAuthenticationKerberosRealmOpts - Optional Parameters:
     * @param "OpaquePassword" (optional.String) -  Accept opaque attributes in the request or return opaque attributes in the response, encrypted with the specified password. See the documentation for the &#x60;opaquePassword&#x60; parameter.
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return MsgVpnAuthenticationKerberosRealmResponse
*/

type AuthenticationKerberosRealmApiUpdateMsgVpnAuthenticationKerberosRealmOpts struct {
    OpaquePassword optional.String
    Select_ optional.Interface
}

func (a *AuthenticationKerberosRealmApiService) UpdateMsgVpnAuthenticationKerberosRealm(ctx context.Context, body MsgVpnAuthenticationKerberosRealm, msgVpnName string, kerberosRealmName string, localVarOptionals *AuthenticationKerberosRealmApiUpdateMsgVpnAuthenticationKerberosRealmOpts) (MsgVpnAuthenticationKerberosRealmResponse, *http.Response, error) {
	var (
