...
type MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeadersResponse struct {
	Data []MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader `json:"data,omitempty"`
	Links []MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeaderLinks `json:"links,omitempty"`
