...
type MsgVpnBridgeRemoteSubscription struct {
	...
	// Enable or disable deliver-always for the Bridge remote subscription topic instead of a deliver-to-one remote priority. A given topic for the Bridge may be deliver-to-one or deliver-always but not both.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\".
	...
	// The topic of the Bridge remote subscription.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\".
