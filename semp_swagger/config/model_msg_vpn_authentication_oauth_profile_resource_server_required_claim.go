...
type MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim struct {
	...
	// The name of the OAuth profile.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\".
	OauthProfileName string `json:"oauthProfileName,omitempty"`
	// The name of the access token claim to verify.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\".
	ResourceServerRequiredClaimName string `json:"resourceServerRequiredClaimName,omitempty"`
	// The required claim value.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\".
