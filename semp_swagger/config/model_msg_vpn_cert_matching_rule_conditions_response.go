...
type MsgVpnCertMatchingRuleConditionsResponse struct {
	Data []MsgVpnCertMatchingRuleCondition `json:"data,omitempty"`
	Links []MsgVpnCertMatchingRuleConditionLinks `json:"links,omitempty"`
