...
type AboutApi struct {
	// The platform running the SEMP API.  The minimum access scope/level required to retrieve this attribute is \"global/none\".
	Platform string `json:"platform,omitempty"`
	// The version of the SEMP API.  The minimum access scope/level required to retrieve this attribute is \"global/none\".
