...
type MsgVpnKafkaReceiverTopicBindingsResponse struct {
	Data []MsgVpnKafkaReceiverTopicBinding `json:"data,omitempty"`
	Links []MsgVpnKafkaReceiverTopicBindingLinks `json:"links,omitempty"`
