...
type DmrClusterCertMatchingRulesResponse struct {
	Data []DmrClusterCertMatchingRule `json:"data,omitempty"`
	Links []DmrClusterCertMatchingRuleLinks `json:"links,omitempty"`
