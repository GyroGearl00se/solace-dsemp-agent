...
type MsgVpnTelemetryProfileTraceFiltersResponse struct {
	Data []MsgVpnTelemetryProfileTraceFilter `json:"data,omitempty"`
	Links []MsgVpnTelemetryProfileTraceFilterLinks `json:"links,omitempty"`
