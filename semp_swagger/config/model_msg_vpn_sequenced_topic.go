...
type MsgVpnSequencedTopic struct {
	// The name of the Message VPN.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\". Deprecated since 2.42. Primarily used by SolCache-RS which has been replaced by the Replay feature.
	MsgVpnName string `json:"msgVpnName,omitempty"`
	// Topic for applying sequence numbers.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\". Deprecated since 2.42. Primarily used by SolCache-RS which has been replaced by the Replay feature.
