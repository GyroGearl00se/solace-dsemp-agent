...
type MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix struct {
	...
	// The name of the remote Home Cache Cluster.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\".
	...
	// A topic prefix for global topics available from the remote Home Cache Cluster. A wildcard (/&gt;) is implied at the end of the prefix.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\".
