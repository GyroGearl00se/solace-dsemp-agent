...
type SystemInformation struct {
	// The platform running the SEMP API.  The minimum access scope/level required to retrieve this attribute is \"global/none\". Deprecated since 2.2. /systemInformation was replaced by /about/api.
	Platform string `json:"platform,omitempty"`
	// The version of the SEMP API.  The minimum access scope/level required to retrieve this attribute is \"global/none\". Deprecated since 2.2. /systemInformation was replaced by /about/api.
