...
*AllApi* | [**DeleteMsgVpnKafkaReceiverTopicBinding**](docs/AllApi.md#deletemsgvpnkafkareceivertopicbinding) | **Delete** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName}/topicBindings/{topicName} | Delete a Topic Binding object.
...
*AllApi* | [**GetMsgVpnKafkaReceiverTopicBindings**](docs/AllApi.md#getmsgvpnkafkareceivertopicbindings) | **Get** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName}/topicBindings | Get a list of Topic Binding objects.
...
*AllApi* | [**GetProxies**](docs/AllApi.md#getproxies) | **Get** /proxies | Get a list of Proxy objects.
*AllApi* | [**GetProxy**](docs/AllApi.md#getproxy) | **Get** /proxies/{proxyName} | Get a Proxy object.
...
*AllApi* | [**ReplaceMsgVpnAuthenticationKerberosRealm**](docs/AllApi.md#replacemsgvpnauthenticationkerberosrealm) | **Put** /msgVpns/{msgVpnName}/authenticationKerberosRealms/{kerberosRealmName} | Replace a Realm object.
...
*AllApi* | [**ReplaceMsgVpnKafkaReceiver**](docs/AllApi.md#replacemsgvpnkafkareceiver) | **Put** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName} | Replace a Kafka Receiver object.
*AllApi* | [**ReplaceMsgVpnKafkaReceiverTopicBinding**](docs/AllApi.md#replacemsgvpnkafkareceivertopicbinding) | **Put** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName}/topicBindings/{topicName} | Replace a Topic Binding object.
*AllApi* | [**ReplaceMsgVpnKafkaSender**](docs/AllApi.md#replacemsgvpnkafkasender) | **Put** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName} | Replace a Kafka Sender object.
*AllApi* | [**ReplaceMsgVpnKafkaSenderQueueBinding**](docs/AllApi.md#replacemsgvpnkafkasenderqueuebinding) | **Put** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName}/queueBindings/{queueName} | Replace a Queue Binding object.
...
*AllApi* | [**ReplaceMsgVpnProxy**](docs/AllApi.md#replacemsgvpnproxy) | **Put** /msgVpns/{msgVpnName}/proxies/{proxyName} | Replace a Proxy object.
...
*AllApi* | [**ReplaceProxy**](docs/AllApi.md#replaceproxy) | **Put** /proxies/{proxyName} | Replace a Proxy object.
...
*AllApi* | [**UpdateMsgVpnAuthenticationKerberosRealm**](docs/AllApi.md#updatemsgvpnauthenticationkerberosrealm) | **Patch** /msgVpns/{msgVpnName}/authenticationKerberosRealms/{kerberosRealmName} | Update a Realm object.
...
*AllApi* | [**UpdateMsgVpnKafkaReceiver**](docs/AllApi.md#updatemsgvpnkafkareceiver) | **Patch** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName} | Update a Kafka Receiver object.
*AllApi* | [**UpdateMsgVpnKafkaReceiverTopicBinding**](docs/AllApi.md#updatemsgvpnkafkareceivertopicbinding) | **Patch** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName}/topicBindings/{topicName} | Update a Topic Binding object.
*AllApi* | [**UpdateMsgVpnKafkaSender**](docs/AllApi.md#updatemsgvpnkafkasender) | **Patch** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName} | Update a Kafka Sender object.
*AllApi* | [**UpdateMsgVpnKafkaSenderQueueBinding**](docs/AllApi.md#updatemsgvpnkafkasenderqueuebinding) | **Patch** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName}/queueBindings/{queueName} | Update a Queue Binding object.
...
*AllApi* | [**UpdateMsgVpnProxy**](docs/AllApi.md#updatemsgvpnproxy) | **Patch** /msgVpns/{msgVpnName}/proxies/{proxyName} | Update a Proxy object.
...
*AllApi* | [**UpdateProxy**](docs/AllApi.md#updateproxy) | **Patch** /proxies/{proxyName} | Update a Proxy object.
...
*AuthenticationKerberosRealmApi* | [**CreateMsgVpnAuthenticationKerberosRealm**](docs/AuthenticationKerberosRealmApi.md#createmsgvpnauthenticationkerberosrealm) | **Post** /msgVpns/{msgVpnName}/authenticationKerberosRealms | Create a Realm object.
*AuthenticationKerberosRealmApi* | [**DeleteMsgVpnAuthenticationKerberosRealm**](docs/AuthenticationKerberosRealmApi.md#deletemsgvpnauthenticationkerberosrealm) | **Delete** /msgVpns/{msgVpnName}/authenticationKerberosRealms/{kerberosRealmName} | Delete a Realm object.
*AuthenticationKerberosRealmApi* | [**GetMsgVpnAuthenticationKerberosRealm**](docs/AuthenticationKerberosRealmApi.md#getmsgvpnauthenticationkerberosrealm) | **Get** /msgVpns/{msgVpnName}/authenticationKerberosRealms/{kerberosRealmName} | Get a Realm object.
*AuthenticationKerberosRealmApi* | [**GetMsgVpnAuthenticationKerberosRealms**](docs/AuthenticationKerberosRealmApi.md#getmsgvpnauthenticationkerberosrealms) | **Get** /msgVpns/{msgVpnName}/authenticationKerberosRealms | Get a list of Realm objects.
*AuthenticationKerberosRealmApi* | [**ReplaceMsgVpnAuthenticationKerberosRealm**](docs/AuthenticationKerberosRealmApi.md#replacemsgvpnauthenticationkerberosrealm) | **Put** /msgVpns/{msgVpnName}/authenticationKerberosRealms/{kerberosRealmName} | Replace a Realm object.
*AuthenticationKerberosRealmApi* | [**UpdateMsgVpnAuthenticationKerberosRealm**](docs/AuthenticationKerberosRealmApi.md#updatemsgvpnauthenticationkerberosrealm) | **Patch** /msgVpns/{msgVpnName}/authenticationKerberosRealms/{kerberosRealmName} | Update a Realm object.
...
*KafkaReceiverApi* | [**CreateMsgVpnKafkaReceiver**](docs/KafkaReceiverApi.md#createmsgvpnkafkareceiver) | **Post** /msgVpns/{msgVpnName}/kafkaReceivers | Create a Kafka Receiver object.
*KafkaReceiverApi* | [**CreateMsgVpnKafkaReceiverTopicBinding**](docs/KafkaReceiverApi.md#createmsgvpnkafkareceivertopicbinding) | **Post** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName}/topicBindings | Create a Topic Binding object.
*KafkaReceiverApi* | [**DeleteMsgVpnKafkaReceiver**](docs/KafkaReceiverApi.md#deletemsgvpnkafkareceiver) | **Delete** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName} | Delete a Kafka Receiver object.
*KafkaReceiverApi* | [**DeleteMsgVpnKafkaReceiverTopicBinding**](docs/KafkaReceiverApi.md#deletemsgvpnkafkareceivertopicbinding) | **Delete** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName}/topicBindings/{topicName} | Delete a Topic Binding object.
*KafkaReceiverApi* | [**GetMsgVpnKafkaReceiver**](docs/KafkaReceiverApi.md#getmsgvpnkafkareceiver) | **Get** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName} | Get a Kafka Receiver object.
*KafkaReceiverApi* | [**GetMsgVpnKafkaReceiverTopicBinding**](docs/KafkaReceiverApi.md#getmsgvpnkafkareceivertopicbinding) | **Get** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName}/topicBindings/{topicName} | Get a Topic Binding object.
*KafkaReceiverApi* | [**GetMsgVpnKafkaReceiverTopicBindings**](docs/KafkaReceiverApi.md#getmsgvpnkafkareceivertopicbindings) | **Get** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName}/topicBindings | Get a list of Topic Binding objects.
*KafkaReceiverApi* | [**GetMsgVpnKafkaReceivers**](docs/KafkaReceiverApi.md#getmsgvpnkafkareceivers) | **Get** /msgVpns/{msgVpnName}/kafkaReceivers | Get a list of Kafka Receiver objects.
*KafkaReceiverApi* | [**ReplaceMsgVpnKafkaReceiver**](docs/KafkaReceiverApi.md#replacemsgvpnkafkareceiver) | **Put** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName} | Replace a Kafka Receiver object.
*KafkaReceiverApi* | [**ReplaceMsgVpnKafkaReceiverTopicBinding**](docs/KafkaReceiverApi.md#replacemsgvpnkafkareceivertopicbinding) | **Put** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName}/topicBindings/{topicName} | Replace a Topic Binding object.
*KafkaReceiverApi* | [**UpdateMsgVpnKafkaReceiver**](docs/KafkaReceiverApi.md#updatemsgvpnkafkareceiver) | **Patch** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName} | Update a Kafka Receiver object.
*KafkaReceiverApi* | [**UpdateMsgVpnKafkaReceiverTopicBinding**](docs/KafkaReceiverApi.md#updatemsgvpnkafkareceivertopicbinding) | **Patch** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName}/topicBindings/{topicName} | Update a Topic Binding object.
*KafkaSenderApi* | [**CreateMsgVpnKafkaSender**](docs/KafkaSenderApi.md#createmsgvpnkafkasender) | **Post** /msgVpns/{msgVpnName}/kafkaSenders | Create a Kafka Sender object.
*KafkaSenderApi* | [**CreateMsgVpnKafkaSenderQueueBinding**](docs/KafkaSenderApi.md#createmsgvpnkafkasenderqueuebinding) | **Post** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName}/queueBindings | Create a Queue Binding object.
*KafkaSenderApi* | [**DeleteMsgVpnKafkaSender**](docs/KafkaSenderApi.md#deletemsgvpnkafkasender) | **Delete** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName} | Delete a Kafka Sender object.
*KafkaSenderApi* | [**DeleteMsgVpnKafkaSenderQueueBinding**](docs/KafkaSenderApi.md#deletemsgvpnkafkasenderqueuebinding) | **Delete** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName}/queueBindings/{queueName} | Delete a Queue Binding object.
*KafkaSenderApi* | [**GetMsgVpnKafkaSender**](docs/KafkaSenderApi.md#getmsgvpnkafkasender) | **Get** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName} | Get a Kafka Sender object.
*KafkaSenderApi* | [**GetMsgVpnKafkaSenderQueueBinding**](docs/KafkaSenderApi.md#getmsgvpnkafkasenderqueuebinding) | **Get** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName}/queueBindings/{queueName} | Get a Queue Binding object.
*KafkaSenderApi* | [**GetMsgVpnKafkaSenderQueueBindings**](docs/KafkaSenderApi.md#getmsgvpnkafkasenderqueuebindings) | **Get** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName}/queueBindings | Get a list of Queue Binding objects.
*KafkaSenderApi* | [**GetMsgVpnKafkaSenders**](docs/KafkaSenderApi.md#getmsgvpnkafkasenders) | **Get** /msgVpns/{msgVpnName}/kafkaSenders | Get a list of Kafka Sender objects.
*KafkaSenderApi* | [**ReplaceMsgVpnKafkaSender**](docs/KafkaSenderApi.md#replacemsgvpnkafkasender) | **Put** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName} | Replace a Kafka Sender object.
*KafkaSenderApi* | [**ReplaceMsgVpnKafkaSenderQueueBinding**](docs/KafkaSenderApi.md#replacemsgvpnkafkasenderqueuebinding) | **Put** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName}/queueBindings/{queueName} | Replace a Queue Binding object.
*KafkaSenderApi* | [**UpdateMsgVpnKafkaSender**](docs/KafkaSenderApi.md#updatemsgvpnkafkasender) | **Patch** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName} | Update a Kafka Sender object.
*KafkaSenderApi* | [**UpdateMsgVpnKafkaSenderQueueBinding**](docs/KafkaSenderApi.md#updatemsgvpnkafkasenderqueuebinding) | **Patch** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName}/queueBindings/{queueName} | Update a Queue Binding object.
...
*MsgVpnApi* | [**CreateMsgVpnAuthenticationKerberosRealm**](docs/MsgVpnApi.md#createmsgvpnauthenticationkerberosrealm) | **Post** /msgVpns/{msgVpnName}/authenticationKerberosRealms | Create a Realm object.
...
*MsgVpnApi* | [**CreateMsgVpnKafkaReceiver**](docs/MsgVpnApi.md#createmsgvpnkafkareceiver) | **Post** /msgVpns/{msgVpnName}/kafkaReceivers | Create a Kafka Receiver object.
*MsgVpnApi* | [**CreateMsgVpnKafkaReceiverTopicBinding**](docs/MsgVpnApi.md#createmsgvpnkafkareceivertopicbinding) | **Post** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName}/topicBindings | Create a Topic Binding object.
*MsgVpnApi* | [**CreateMsgVpnKafkaSender**](docs/MsgVpnApi.md#createmsgvpnkafkasender) | **Post** /msgVpns/{msgVpnName}/kafkaSenders | Create a Kafka Sender object.
*MsgVpnApi* | [**CreateMsgVpnKafkaSenderQueueBinding**](docs/MsgVpnApi.md#createmsgvpnkafkasenderqueuebinding) | **Post** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName}/queueBindings | Create a Queue Binding object.
...
*MsgVpnApi* | [**CreateMsgVpnProxy**](docs/MsgVpnApi.md#createmsgvpnproxy) | **Post** /msgVpns/{msgVpnName}/proxies | Create a Proxy object.
...
*MsgVpnApi* | [**DeleteMsgVpnAuthenticationKerberosRealm**](docs/MsgVpnApi.md#deletemsgvpnauthenticationkerberosrealm) | **Delete** /msgVpns/{msgVpnName}/authenticationKerberosRealms/{kerberosRealmName} | Delete a Realm object.
...
*MsgVpnApi* | [**DeleteMsgVpnKafkaReceiver**](docs/MsgVpnApi.md#deletemsgvpnkafkareceiver) | **Delete** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName} | Delete a Kafka Receiver object.
*MsgVpnApi* | [**DeleteMsgVpnKafkaReceiverTopicBinding**](docs/MsgVpnApi.md#deletemsgvpnkafkareceivertopicbinding) | **Delete** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName}/topicBindings/{topicName} | Delete a Topic Binding object.
*MsgVpnApi* | [**DeleteMsgVpnKafkaSender**](docs/MsgVpnApi.md#deletemsgvpnkafkasender) | **Delete** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName} | Delete a Kafka Sender object.
*MsgVpnApi* | [**DeleteMsgVpnKafkaSenderQueueBinding**](docs/MsgVpnApi.md#deletemsgvpnkafkasenderqueuebinding) | **Delete** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName}/queueBindings/{queueName} | Delete a Queue Binding object.
...
*MsgVpnApi* | [**DeleteMsgVpnProxy**](docs/MsgVpnApi.md#deletemsgvpnproxy) | **Delete** /msgVpns/{msgVpnName}/proxies/{proxyName} | Delete a Proxy object.
...
*MsgVpnApi* | [**GetMsgVpnAuthenticationKerberosRealm**](docs/MsgVpnApi.md#getmsgvpnauthenticationkerberosrealm) | **Get** /msgVpns/{msgVpnName}/authenticationKerberosRealms/{kerberosRealmName} | Get a Realm object.
*MsgVpnApi* | [**GetMsgVpnAuthenticationKerberosRealms**](docs/MsgVpnApi.md#getmsgvpnauthenticationkerberosrealms) | **Get** /msgVpns/{msgVpnName}/authenticationKerberosRealms | Get a list of Realm objects.
...
*MsgVpnApi* | [**GetMsgVpnKafkaReceiver**](docs/MsgVpnApi.md#getmsgvpnkafkareceiver) | **Get** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName} | Get a Kafka Receiver object.
*MsgVpnApi* | [**GetMsgVpnKafkaReceiverTopicBinding**](docs/MsgVpnApi.md#getmsgvpnkafkareceivertopicbinding) | **Get** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName}/topicBindings/{topicName} | Get a Topic Binding object.
*MsgVpnApi* | [**GetMsgVpnKafkaReceiverTopicBindings**](docs/MsgVpnApi.md#getmsgvpnkafkareceivertopicbindings) | **Get** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName}/topicBindings | Get a list of Topic Binding objects.
*MsgVpnApi* | [**GetMsgVpnKafkaReceivers**](docs/MsgVpnApi.md#getmsgvpnkafkareceivers) | **Get** /msgVpns/{msgVpnName}/kafkaReceivers | Get a list of Kafka Receiver objects.
*MsgVpnApi* | [**GetMsgVpnKafkaSender**](docs/MsgVpnApi.md#getmsgvpnkafkasender) | **Get** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName} | Get a Kafka Sender object.
*MsgVpnApi* | [**GetMsgVpnKafkaSenderQueueBinding**](docs/MsgVpnApi.md#getmsgvpnkafkasenderqueuebinding) | **Get** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName}/queueBindings/{queueName} | Get a Queue Binding object.
*MsgVpnApi* | [**GetMsgVpnKafkaSenderQueueBindings**](docs/MsgVpnApi.md#getmsgvpnkafkasenderqueuebindings) | **Get** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName}/queueBindings | Get a list of Queue Binding objects.
*MsgVpnApi* | [**GetMsgVpnKafkaSenders**](docs/MsgVpnApi.md#getmsgvpnkafkasenders) | **Get** /msgVpns/{msgVpnName}/kafkaSenders | Get a list of Kafka Sender objects.
...
*MsgVpnApi* | [**GetMsgVpnProxies**](docs/MsgVpnApi.md#getmsgvpnproxies) | **Get** /msgVpns/{msgVpnName}/proxies | Get a list of Proxy objects.
*MsgVpnApi* | [**GetMsgVpnProxy**](docs/MsgVpnApi.md#getmsgvpnproxy) | **Get** /msgVpns/{msgVpnName}/proxies/{proxyName} | Get a Proxy object.
...
*MsgVpnApi* | [**ReplaceMsgVpnAuthenticationKerberosRealm**](docs/MsgVpnApi.md#replacemsgvpnauthenticationkerberosrealm) | **Put** /msgVpns/{msgVpnName}/authenticationKerberosRealms/{kerberosRealmName} | Replace a Realm object.
...
*MsgVpnApi* | [**ReplaceMsgVpnKafkaReceiver**](docs/MsgVpnApi.md#replacemsgvpnkafkareceiver) | **Put** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName} | Replace a Kafka Receiver object.
*MsgVpnApi* | [**ReplaceMsgVpnKafkaReceiverTopicBinding**](docs/MsgVpnApi.md#replacemsgvpnkafkareceivertopicbinding) | **Put** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName}/topicBindings/{topicName} | Replace a Topic Binding object.
*MsgVpnApi* | [**ReplaceMsgVpnKafkaSender**](docs/MsgVpnApi.md#replacemsgvpnkafkasender) | **Put** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName} | Replace a Kafka Sender object.
*MsgVpnApi* | [**ReplaceMsgVpnKafkaSenderQueueBinding**](docs/MsgVpnApi.md#replacemsgvpnkafkasenderqueuebinding) | **Put** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName}/queueBindings/{queueName} | Replace a Queue Binding object.
...
*MsgVpnApi* | [**ReplaceMsgVpnProxy**](docs/MsgVpnApi.md#replacemsgvpnproxy) | **Put** /msgVpns/{msgVpnName}/proxies/{proxyName} | Replace a Proxy object.
...
*MsgVpnApi* | [**UpdateMsgVpnAuthenticationKerberosRealm**](docs/MsgVpnApi.md#updatemsgvpnauthenticationkerberosrealm) | **Patch** /msgVpns/{msgVpnName}/authenticationKerberosRealms/{kerberosRealmName} | Update a Realm object.
...
*MsgVpnApi* | [**UpdateMsgVpnKafkaReceiver**](docs/MsgVpnApi.md#updatemsgvpnkafkareceiver) | **Patch** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName} | Update a Kafka Receiver object.
*MsgVpnApi* | [**UpdateMsgVpnKafkaReceiverTopicBinding**](docs/MsgVpnApi.md#updatemsgvpnkafkareceivertopicbinding) | **Patch** /msgVpns/{msgVpnName}/kafkaReceivers/{kafkaReceiverName}/topicBindings/{topicName} | Update a Topic Binding object.
*MsgVpnApi* | [**UpdateMsgVpnKafkaSender**](docs/MsgVpnApi.md#updatemsgvpnkafkasender) | **Patch** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName} | Update a Kafka Sender object.
*MsgVpnApi* | [**UpdateMsgVpnKafkaSenderQueueBinding**](docs/MsgVpnApi.md#updatemsgvpnkafkasenderqueuebinding) | **Patch** /msgVpns/{msgVpnName}/kafkaSenders/{kafkaSenderName}/queueBindings/{queueName} | Update a Queue Binding object.
...
*MsgVpnApi* | [**UpdateMsgVpnProxy**](docs/MsgVpnApi.md#updatemsgvpnproxy) | **Patch** /msgVpns/{msgVpnName}/proxies/{proxyName} | Update a Proxy object.
...
*ProxyApi* | [**CreateMsgVpnProxy**](docs/ProxyApi.md#createmsgvpnproxy) | **Post** /msgVpns/{msgVpnName}/proxies | Create a Proxy object.
*ProxyApi* | [**CreateProxy**](docs/ProxyApi.md#createproxy) | **Post** /proxies | Create a Proxy object.
*ProxyApi* | [**DeleteMsgVpnProxy**](docs/ProxyApi.md#deletemsgvpnproxy) | **Delete** /msgVpns/{msgVpnName}/proxies/{proxyName} | Delete a Proxy object.
*ProxyApi* | [**DeleteProxy**](docs/ProxyApi.md#deleteproxy) | **Delete** /proxies/{proxyName} | Delete a Proxy object.
*ProxyApi* | [**GetMsgVpnProxies**](docs/ProxyApi.md#getmsgvpnproxies) | **Get** /msgVpns/{msgVpnName}/proxies | Get a list of Proxy objects.
*ProxyApi* | [**GetMsgVpnProxy**](docs/ProxyApi.md#getmsgvpnproxy) | **Get** /msgVpns/{msgVpnName}/proxies/{proxyName} | Get a Proxy object.
*ProxyApi* | [**GetProxies**](docs/ProxyApi.md#getproxies) | **Get** /proxies | Get a list of Proxy objects.
*ProxyApi* | [**GetProxy**](docs/ProxyApi.md#getproxy) | **Get** /proxies/{proxyName} | Get a Proxy object.
*ProxyApi* | [**ReplaceMsgVpnProxy**](docs/ProxyApi.md#replacemsgvpnproxy) | **Put** /msgVpns/{msgVpnName}/proxies/{proxyName} | Replace a Proxy object.
*ProxyApi* | [**ReplaceProxy**](docs/ProxyApi.md#replaceproxy) | **Put** /proxies/{proxyName} | Replace a Proxy object.
*ProxyApi* | [**UpdateMsgVpnProxy**](docs/ProxyApi.md#updatemsgvpnproxy) | **Patch** /msgVpns/{msgVpnName}/proxies/{proxyName} | Update a Proxy object.
*ProxyApi* | [**UpdateProxy**](docs/ProxyApi.md#updateproxy) | **Patch** /proxies/{proxyName} | Update a Proxy object.
...
## Documentation For Models
 ...
 - [BrokerGuaranteedMsgingEventCacheUsageThreshold](docs/BrokerGuaranteedMsgingEventCacheUsageThreshold.md)
 - [BrokerGuaranteedMsgingEventDeliveredUnackedThreshold](docs/BrokerGuaranteedMsgingEventDeliveredUnackedThreshold.md)
 - [BrokerGuaranteedMsgingEventDiskUsageThreshold](docs/BrokerGuaranteedMsgingEventDiskUsageThreshold.md)
 - [BrokerGuaranteedMsgingEventEgressFlowCountThreshold](docs/BrokerGuaranteedMsgingEventEgressFlowCountThreshold.md)
 - [BrokerGuaranteedMsgingEventEndpointCountThreshold](docs/BrokerGuaranteedMsgingEventEndpointCountThreshold.md)
 - [BrokerGuaranteedMsgingEventIngressFlowCountThreshold](docs/BrokerGuaranteedMsgingEventIngressFlowCountThreshold.md)
 - [BrokerGuaranteedMsgingEventMsgCountThreshold](docs/BrokerGuaranteedMsgingEventMsgCountThreshold.md)
 - [BrokerGuaranteedMsgingEventMsgSpoolFileCountThreshold](docs/BrokerGuaranteedMsgingEventMsgSpoolFileCountThreshold.md)
 - [BrokerGuaranteedMsgingEventMsgSpoolUsageThreshold](docs/BrokerGuaranteedMsgingEventMsgSpoolUsageThreshold.md)
 - [BrokerGuaranteedMsgingEventTransactedSessionCountThreshold](docs/BrokerGuaranteedMsgingEventTransactedSessionCountThreshold.md)
 - [BrokerGuaranteedMsgingEventTransactedSessionResourceCountThreshold](docs/BrokerGuaranteedMsgingEventTransactedSessionResourceCountThreshold.md)
 - [BrokerGuaranteedMsgingEventTransactionCountThreshold](docs/BrokerGuaranteedMsgingEventTransactionCountThreshold.md)
 - [BrokerLinks](docs/BrokerLinks.md)
 - [BrokerResponse](docs/BrokerResponse.md)
 - [BrokerServiceEventConnectionCountThreshold](docs/BrokerServiceEventConnectionCountThreshold.md)
 - [BrokerServiceRestEventOutgoingConnectionCountThreshold](docs/BrokerServiceRestEventOutgoingConnectionCountThreshold.md)
 - [BrokerServiceSmfEventConnectionCountThreshold](docs/BrokerServiceSmfEventConnectionCountThreshold.md)
 - [BrokerServiceTlsEventConnectionCountThreshold](docs/BrokerServiceTlsEventConnectionCountThreshold.md)
 ...
 - [DmrClusterLinkQueueEventSpoolUsageThreshold](docs/DmrClusterLinkQueueEventSpoolUsageThreshold.md)
 ...
 - [MsgVpnAuthenticationKerberosRealm](docs/MsgVpnAuthenticationKerberosRealm.md)
 - [MsgVpnAuthenticationKerberosRealmLinks](docs/MsgVpnAuthenticationKerberosRealmLinks.md)
 - [MsgVpnAuthenticationKerberosRealmResponse](docs/MsgVpnAuthenticationKerberosRealmResponse.md)
 - [MsgVpnAuthenticationKerberosRealmsResponse](docs/MsgVpnAuthenticationKerberosRealmsResponse.md)
 ...
 - [MsgVpnClientProfileEventClientProvisionedEndpointSpoolUsageThreshold](docs/MsgVpnClientProfileEventClientProvisionedEndpointSpoolUsageThreshold.md)
 - [MsgVpnClientProfileEventConnectionCountPerClientUsernameThreshold](docs/MsgVpnClientProfileEventConnectionCountPerClientUsernameThreshold.md)
 - [MsgVpnClientProfileEventEgressFlowCountThreshold](docs/MsgVpnClientProfileEventEgressFlowCountThreshold.md)
 - [MsgVpnClientProfileEventEndpointCountPerClientUsernameThreshold](docs/MsgVpnClientProfileEventEndpointCountPerClientUsernameThreshold.md)
 - [MsgVpnClientProfileEventIngressFlowCountThreshold](docs/MsgVpnClientProfileEventIngressFlowCountThreshold.md)
 - [MsgVpnClientProfileEventServiceSmfConnectionCountPerClientUsernameThreshold](docs/MsgVpnClientProfileEventServiceSmfConnectionCountPerClientUsernameThreshold.md)
 - [MsgVpnClientProfileEventServiceWebConnectionCountPerClientUsernameThreshold](docs/MsgVpnClientProfileEventServiceWebConnectionCountPerClientUsernameThreshold.md)
 - [MsgVpnClientProfileEventSubscriptionCountThreshold](docs/MsgVpnClientProfileEventSubscriptionCountThreshold.md)
 - [MsgVpnClientProfileEventTransactedSessionCountThreshold](docs/MsgVpnClientProfileEventTransactedSessionCountThreshold.md)
 - [MsgVpnClientProfileEventTransactionCountThreshold](docs/MsgVpnClientProfileEventTransactionCountThreshold.md)
 ...
 - [MsgVpnDistributedCacheClusterEventDataByteRateThreshold](docs/MsgVpnDistributedCacheClusterEventDataByteRateThreshold.md)
 - [MsgVpnDistributedCacheClusterEventDataMsgRateThreshold](docs/MsgVpnDistributedCacheClusterEventDataMsgRateThreshold.md)
 - [MsgVpnDistributedCacheClusterEventMaxMemoryThreshold](docs/MsgVpnDistributedCacheClusterEventMaxMemoryThreshold.md)
 - [MsgVpnDistributedCacheClusterEventMaxTopicsThreshold](docs/MsgVpnDistributedCacheClusterEventMaxTopicsThreshold.md)
 - [MsgVpnDistributedCacheClusterEventRequestQueueDepthThreshold](docs/MsgVpnDistributedCacheClusterEventRequestQueueDepthThreshold.md)
 - [MsgVpnDistributedCacheClusterEventRequestRateThreshold](docs/MsgVpnDistributedCacheClusterEventRequestRateThreshold.md)
 - [MsgVpnDistributedCacheClusterEventResponseRateThreshold](docs/MsgVpnDistributedCacheClusterEventResponseRateThreshold.md)
 ...
 - [MsgVpnEventConnectionCountThreshold](docs/MsgVpnEventConnectionCountThreshold.md)
 - [MsgVpnEventEgressFlowCountThreshold](docs/MsgVpnEventEgressFlowCountThreshold.md)
 - [MsgVpnEventEgressMsgRateThreshold](docs/MsgVpnEventEgressMsgRateThreshold.md)
 - [MsgVpnEventEndpointCountThreshold](docs/MsgVpnEventEndpointCountThreshold.md)
 - [MsgVpnEventIngressFlowCountThreshold](docs/MsgVpnEventIngressFlowCountThreshold.md)
 - [MsgVpnEventIngressMsgRateThreshold](docs/MsgVpnEventIngressMsgRateThreshold.md)
 - [MsgVpnEventMsgSpoolUsageThreshold](docs/MsgVpnEventMsgSpoolUsageThreshold.md)
 - [MsgVpnEventServiceAmqpConnectionCountThreshold](docs/MsgVpnEventServiceAmqpConnectionCountThreshold.md)
 - [MsgVpnEventServiceMqttConnectionCountThreshold](docs/MsgVpnEventServiceMqttConnectionCountThreshold.md)
 - [MsgVpnEventServiceRestIncomingConnectionCountThreshold](docs/MsgVpnEventServiceRestIncomingConnectionCountThreshold.md)
 - [MsgVpnEventServiceSmfConnectionCountThreshold](docs/MsgVpnEventServiceSmfConnectionCountThreshold.md)
 - [MsgVpnEventServiceWebConnectionCountThreshold](docs/MsgVpnEventServiceWebConnectionCountThreshold.md)
 - [MsgVpnEventSubscriptionCountThreshold](docs/MsgVpnEventSubscriptionCountThreshold.md)
 - [MsgVpnEventTransactedSessionCountThreshold](docs/MsgVpnEventTransactedSessionCountThreshold.md)
 - [MsgVpnEventTransactionCountThreshold](docs/MsgVpnEventTransactionCountThreshold.md)
 ...
 - [MsgVpnKafkaReceiver](docs/MsgVpnKafkaReceiver.md)
 - [MsgVpnKafkaReceiverLinks](docs/MsgVpnKafkaReceiverLinks.md)
 - [MsgVpnKafkaReceiverResponse](docs/MsgVpnKafkaReceiverResponse.md)
 - [MsgVpnKafkaReceiverTopicBinding](docs/MsgVpnKafkaReceiverTopicBinding.md)
 - [MsgVpnKafkaReceiverTopicBindingLinks](docs/MsgVpnKafkaReceiverTopicBindingLinks.md)
 - [MsgVpnKafkaReceiverTopicBindingResponse](docs/MsgVpnKafkaReceiverTopicBindingResponse.md)
 - [MsgVpnKafkaReceiverTopicBindingsResponse](docs/MsgVpnKafkaReceiverTopicBindingsResponse.md)
 - [MsgVpnKafkaReceiversResponse](docs/MsgVpnKafkaReceiversResponse.md)
 - [MsgVpnKafkaSender](docs/MsgVpnKafkaSender.md)
 - [MsgVpnKafkaSenderLinks](docs/MsgVpnKafkaSenderLinks.md)
 - [MsgVpnKafkaSenderQueueBinding](docs/MsgVpnKafkaSenderQueueBinding.md)
 - [MsgVpnKafkaSenderQueueBindingLinks](docs/MsgVpnKafkaSenderQueueBindingLinks.md)
 - [MsgVpnKafkaSenderQueueBindingResponse](docs/MsgVpnKafkaSenderQueueBindingResponse.md)
 - [MsgVpnKafkaSenderQueueBindingsResponse](docs/MsgVpnKafkaSenderQueueBindingsResponse.md)
 - [MsgVpnKafkaSenderResponse](docs/MsgVpnKafkaSenderResponse.md)
 - [MsgVpnKafkaSendersResponse](docs/MsgVpnKafkaSendersResponse.md)
 ...
 - [MsgVpnMqttSessionQueueEventBindCountThreshold](docs/MsgVpnMqttSessionQueueEventBindCountThreshold.md)
 - [MsgVpnMqttSessionQueueEventMsgSpoolUsageThreshold](docs/MsgVpnMqttSessionQueueEventMsgSpoolUsageThreshold.md)
 - [MsgVpnMqttSessionQueueEventRejectLowPriorityMsgLimitThreshold](docs/MsgVpnMqttSessionQueueEventRejectLowPriorityMsgLimitThreshold.md)
 ...
 - [MsgVpnProxiesResponse](docs/MsgVpnProxiesResponse.md)
 - [MsgVpnProxy](docs/MsgVpnProxy.md)
 - [MsgVpnProxyLinks](docs/MsgVpnProxyLinks.md)
 - [MsgVpnProxyResponse](docs/MsgVpnProxyResponse.md)
 - [MsgVpnQueue](docs/MsgVpnQueue.md)
 - [MsgVpnQueueEventBindCountThreshold](docs/MsgVpnQueueEventBindCountThreshold.md)
 - [MsgVpnQueueEventMsgSpoolUsageThreshold](docs/MsgVpnQueueEventMsgSpoolUsageThreshold.md)
 - [MsgVpnQueueEventRejectLowPriorityMsgLimitThreshold](docs/MsgVpnQueueEventRejectLowPriorityMsgLimitThreshold.md)
 ...
 - [MsgVpnQueueTemplateEventBindCountThreshold](docs/MsgVpnQueueTemplateEventBindCountThreshold.md)
 - [MsgVpnQueueTemplateEventMsgSpoolUsageThreshold](docs/MsgVpnQueueTemplateEventMsgSpoolUsageThreshold.md)
 - [MsgVpnQueueTemplateEventRejectLowPriorityMsgLimitThreshold](docs/MsgVpnQueueTemplateEventRejectLowPriorityMsgLimitThreshold.md)
 ...
 - [MsgVpnTelemetryProfileQueueEventBindCountThreshold](docs/MsgVpnTelemetryProfileQueueEventBindCountThreshold.md)
 - [MsgVpnTelemetryProfileQueueEventMsgSpoolUsageThreshold](docs/MsgVpnTelemetryProfileQueueEventMsgSpoolUsageThreshold.md)
 ...
 - [MsgVpnTelemetryProfileReceiverEventConnectionCountPerClientUsernameThreshold](docs/MsgVpnTelemetryProfileReceiverEventConnectionCountPerClientUsernameThreshold.md)
 ...
 - [MsgVpnTopicEndpointEventBindCountThreshold](docs/MsgVpnTopicEndpointEventBindCountThreshold.md)
 - [MsgVpnTopicEndpointEventRejectLowPriorityMsgLimitThreshold](docs/MsgVpnTopicEndpointEventRejectLowPriorityMsgLimitThreshold.md)
 - [MsgVpnTopicEndpointEventSpoolUsageThreshold](docs/MsgVpnTopicEndpointEventSpoolUsageThreshold.md)
 ...
 - [MsgVpnTopicEndpointTemplateEventBindCountThreshold](docs/MsgVpnTopicEndpointTemplateEventBindCountThreshold.md)
 - [MsgVpnTopicEndpointTemplateEventMsgSpoolUsageThreshold](docs/MsgVpnTopicEndpointTemplateEventMsgSpoolUsageThreshold.md)
 - [MsgVpnTopicEndpointTemplateEventRejectLowPriorityMsgLimitThreshold](docs/MsgVpnTopicEndpointTemplateEventRejectLowPriorityMsgLimitThreshold.md)
