...
type DmrClusterCertMatchingRuleConditionsResponse struct {
	Data []DmrClusterCertMatchingRuleCondition `json:"data,omitempty"`
	Links []DmrClusterCertMatchingRuleConditionLinks `json:"links,omitempty"`
