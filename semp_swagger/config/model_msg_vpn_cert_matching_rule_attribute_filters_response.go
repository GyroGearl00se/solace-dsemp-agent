...
type MsgVpnCertMatchingRuleAttributeFiltersResponse struct {
	Data []MsgVpnCertMatchingRuleAttributeFilter `json:"data,omitempty"`
	Links []MsgVpnCertMatchingRuleAttributeFilterLinks `json:"links,omitempty"`
