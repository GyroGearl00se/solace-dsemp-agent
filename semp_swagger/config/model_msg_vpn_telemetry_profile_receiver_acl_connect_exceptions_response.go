...
type MsgVpnTelemetryProfileReceiverAclConnectExceptionsResponse struct {
	Data []MsgVpnTelemetryProfileReceiverAclConnectException `json:"data,omitempty"`
	Links []MsgVpnTelemetryProfileReceiverAclConnectExceptionLinks `json:"links,omitempty"`
