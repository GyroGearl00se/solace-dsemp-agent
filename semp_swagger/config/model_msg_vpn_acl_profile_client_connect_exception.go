...
type MsgVpnAclProfileClientConnectException struct {
	...
	// The IP address/netmask of the client connect exception in canonical CIDR form.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\".
