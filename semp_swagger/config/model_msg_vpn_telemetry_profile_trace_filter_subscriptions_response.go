...
type MsgVpnTelemetryProfileTraceFilterSubscriptionsResponse struct {
	Data []MsgVpnTelemetryProfileTraceFilterSubscription `json:"data,omitempty"`
	Links []MsgVpnTelemetryProfileTraceFilterSubscriptionLinks `json:"links,omitempty"`
