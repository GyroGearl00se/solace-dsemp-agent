...
type MsgVpnReplayLogTopicFilterSubscriptionsResponse struct {
	Data []MsgVpnReplayLogTopicFilterSubscription `json:"data,omitempty"`
	Links []MsgVpnReplayLogTopicFilterSubscriptionLinks `json:"links,omitempty"`
