...
type MsgVpnCertMatchingRuleAttributeFilter struct {
	// Client Username Attribute to be tested.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\". The minimum access scope/level required to change this attribute is \"global/mesh-manager\". Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is `\"\"`.
	AttributeName string `json:"attributeName,omitempty"`
	// Expected attribute value.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\". The minimum access scope/level required to change this attribute is \"global/mesh-manager\". Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is `\"\"`.
	AttributeValue string `json:"attributeValue,omitempty"`
	// The name of the filter.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\".
