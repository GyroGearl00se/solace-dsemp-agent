...
type MsgVpnJndiTopic struct {
	...
	// The physical name of the JMS Topic.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\". The minimum access scope/level required to change this attribute is \"vpn/read-write\". Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is `\"\"`.
	PhysicalName string `json:"physicalName,omitempty"`
	// The JNDI name of the JMS Topic.  The minimum access scope/level required to retrieve this attribute is \"vpn/read-only\".
