...
type AboutUserMsgVpn struct {
	// The Message VPN access level of the User.  The minimum access scope/level required to retrieve this attribute is \"global/none\". The allowed values and their meaning are:  <pre> \"none\" - No access. \"read-only\" - Read only access. \"read-write\" - Read and write access. </pre> 
	AccessLevel string `json:"accessLevel,omitempty"`
	// The name of the Message VPN.  The minimum access scope/level required to retrieve this attribute is \"global/none\".
